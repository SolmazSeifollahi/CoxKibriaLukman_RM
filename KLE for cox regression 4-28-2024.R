# Kibria-Lukman estimator for Cox regression model
# 4-28-2024
...
TMSE<- c(TMS1$MSE, TMS2$MSE, TMS3$MSE, TMS4$MSE, TMS5$MSE, TMS6$MSE, TMS7$MSE,
         TMS8$MSE, TMS9$MSE)

TMAE<- c(TMS1$MAE, TMS2$MAE, TMS3$MAE, TMS4$MAE, TMS5$MAE, TMS6$MAE, TMS7$MAE,
         TMS8$MAE, TMS9$MAE)

TBias<- c(TMS1$Bias, TMS2$Bias, TMS3$Bias, TMS4$Bias, TMS5$Bias, TMS6$Bias,
         TMS7$Bias, TMS8$Bias, TMS9$Bias)

OUTFINAL<- matrix(nrow = 3, ncol = 9)
